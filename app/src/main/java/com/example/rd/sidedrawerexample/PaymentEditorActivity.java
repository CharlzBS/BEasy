 ...
 */
public class PaymentEditorActivity extends AppCompatActivity implements ActivityStarter,View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBillPhotosStorageReference = mFirebaseStorage.getReference().child("payment_photos_"+n);
    ...
    private CantFindCameraAppErrorListener cameraAppErrorListener = new CantFindCameraAppErrorListener() {
        ...
        public void cantFindCameraApp() {
            ...
            Toast.makeText(PaymentEditorActivity.this, "Can't find the camera app", Toast.LENGTH_SHORT).show();
        }
    };
    private ErrorCreatingTempFileForCameraListener fileForCameraListener = new ErrorCreatingTempFileForCameraListener() {
        ...
        public void errorCreatingTempFileForCamera() {
            ...
            Toast.makeText(PaymentEditorActivity.this, "Error starting camera", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                NavUtils.navigateUpFromSameTask(PaymentEditorActivity.this);
                return true;
        }
    ...
    public void saveBillDetails() {
        ...
        BillPayment friendlyMessage = new BillPayment(101, "4 March 2017", mSupplierEditNameText.getText().toString(), mBuyerEditNameText.getText().toString(), mBillNumberEditText.getText().toString(), Integer.parseInt(mAmountEditText.getText().toString()),"payment_photos_"+n);

 ...
 */
public class SupplierEditor extends AppCompatActivity implements ActivityStarter {
     ...
     */
    private EditText mSupplierLocationEditText;
    ...
    private EditText mSupplierProductEditText;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBuyerSupplierEditNameText = (EditText) findViewById(R.id.edit_supplier_name);
        mSupplierLocationEditText = (EditText) findViewById(R.id.edit_supplier_location);
        mSupplierContactEditText = (EditText) findViewById(R.id.edit_supplier_contact);
        mSupplierWebsiteEditText = (EditText) findViewById(R.id.edit_supplier_website);
        mSupplierMailEditText = (EditText) findViewById(R.id.edit_supplier_email);
        mSupplierProductEditText = (EditText) findViewById(R.id.edit_supplier_products);
        ...
        mBillsDatabaseReference = mFirebaseDatabase.getReference().child("suppliers");
    ...
    public void saveSupplierDetails() {
        BuyerSupplier buyerSupp = new BuyerSupplier(mBuyerSupplierEditNameText.getText().toString(),mSupplierLocationEditText.getText().toString(),mSupplierContactEditText.getText().toString(),mSupplierWebsiteEditText.getText().toString(),mSupplierMailEditText.getText().toString(),mSupplierProductEditText.getText().toString());
